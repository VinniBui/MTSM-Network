...
contract MTMSToken is Context, Ownable, Pausable, IERC20 {
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    _approve(_msgSender(), spender, SafeMath.sub(_allowances[_msgSender()][spender],subtractedValue, "ERC20: decreased allowance below zero"));
    return true;
  }
  ...
  function burnFrom(address account, uint256 amount) public {
    ...
    uint256 decreasedAllowance = SafeMath.sub(allowance(account, _msgSender()),amount, "ERC20: burn amount exceeds allowance");
